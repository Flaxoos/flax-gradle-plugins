...
import io.github.flaxoos.KoverIgnore
import io.github.flaxoos.kover.ColorBand.Companion.from
import io.github.flaxoos.kover.KoverBadgeTask.Regexes.coverageRegex
import io.github.flaxoos.kover.Names.KOVER_BADGE_DEFAULT_LABEL
import io.github.flaxoos.kover.Names.KOVER_BADGE_EXTENSION_NAME
import io.github.flaxoos.kover.Names.KOVER_BADGE_TASK_GROUP_NAME
...
class KoverBadgePlugin @Inject constructor(val objects: ObjectFactory) : Plugin<Project> {
