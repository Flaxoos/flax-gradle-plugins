...
import io.github.flaxoos.kover.GitCommitOption.Add
import io.github.flaxoos.kover.GitCommitOption.Commit
import io.github.flaxoos.kover.GitCommitOption.CommitReadme
import io.github.flaxoos.kover.GitCommitOption.CommitToNewBranch
import io.github.flaxoos.kover.GitCommitOption.DontCommit
import io.github.flaxoos.kover.Names.KOVER_BADGE_TASK_NAME
import io.github.flaxoos.kover.RegexGroupMatcher.Companion.shouldHaveGroupMatching
import io.github.flaxoos.kover.TestInputs.POSSIBLE_LABELS
import io.github.flaxoos.kover.TestInputs.POSSIBLE_SPECTRUMS
import io.github.flaxoos.kover.TestInputs.randomLabel
import io.github.flaxoos.kover.TestInputs.randomSpectrum
...
class KoverBadgePluginFT : FunSpec() {
    ...
    private fun GradleRunner.withKover(): GradleRunner {
        javaClass.classLoader.getResourceAsStream("testkit-gradle.properties")?.use {
            File(projectDir, "gradle.properties").appendText(it.reader().readText())
        }
                ...
                withData(
                    ...
                    with(
                        ...
                        GradleRunner.create()
                            .withProjectDir(testProjectDir)
                            .withPluginClasspath()
                            .withArguments(KOVER_BADGE_TASK_NAME, "--stacktrace").withKover()
